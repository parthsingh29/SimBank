...
const inputLoginUsername2 = document.querySelector(".login__input--user2");
const inputLoginPassword2 = document.querySelector(".login__input--password2");
...
btnLogin2.addEventListener("click", function (e) {
  ...
  if (currentAccount?.password === +inputLoginPassword2.value) {
    // Display UI and message
    labelWelcome.textContent = `Welcome back, ${
      currentAccount.owner.split(" ")[0]
    }`;
